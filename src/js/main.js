(function () {
  ...
  const customerPulseLink = document.getElementById('customer-pulse-link');
  const docDiveLink = document.getElementById('doc-dive-link');

  if (currentUrl.includes('/cusomer-pulse.html')) {
    customerPulseLink.classList.add('active');
    docDiveLink.classList.remove('active');
  } else if (currentUrl.includes('/doc-dive.html')) {
    docDiveLink.classList.add('active');
    customerPulseLink.classList.remove('active');
  } else {
    customerPulseLink.classList.remove('active');
    docDiveLink.classList.remove('active');
  }
  ...
  function revealAnimations () {
    ...
    // about and team
    sr.reveal('.about-header, .team-header', {
      duration: 600,
      distance: '40px',
      easing: 'cubic-bezier(0.215, 0.61, 0.355, 1)',
      origin: 'top',
    ...
    sr.reveal('.about-text, .team-text', {
      duration: 600,
      distance: '100px',
      easing: 'cubic-bezier(0.215, 0.61, 0.355, 1)',
      origin: 'bottom',
